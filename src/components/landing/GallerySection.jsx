...
const images = [
  {
    src: 'https://media.base44.com/images/public/user_69bae9a8ecb9173375c4d6ff/81b7f8329_b40f8f63571d753d4e97fb3e14f4eb43.jpg',
    alt: 'Arepas rellenas',
    // Ocupa 2 columnas en escritorio para resaltar
  ...
  {
    src: '/img/dbb938297538a8a9ff92de32a3e5943d.jpg', // Usando tu ruta local corregida
    alt: 'Brochetas',
...
export default function GallerySection() {
  return (
    <section id="galeria" className="py-20 md:py-32 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="font-body text-muted-foreground mt-4 text-lg max-w-xl mx-auto">
            Un vistazo a los sabores que preparamos cada día
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[200px] md:auto-rows-[250px]">
          {images.map((img, i) => (
            <motion.div
              key={img.alt}
              className={`group relative overflow-hidden rounded-3xl shadow-lg ${img.className}`}
            ...
            >
              ...
              {/* Overlay con gradiente para que el texto se lea mejor */}
