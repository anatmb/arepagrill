...
//       {/* Content */}
//       <div className="relative z-10 flex flex-col items-center text-center px-6 pt-40 md:pt-24">
//         {/* <motion.img
//           src={LOGO_URL}
...
export default function HeroSection() {
  return (
    ...
    <section id="inicio" className="relative h-[80svh] md:min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      {/* 2. Quitamos el pt-40 de móvil para que el texto se centre solo */}
      <div className="relative z-10 flex flex-col items-center text-center px-6 md:pt-24">
        ...
        {/* Scroll indicator - Solo se verá en escritorio para no amontonar el móvil */}
        <motion.div
